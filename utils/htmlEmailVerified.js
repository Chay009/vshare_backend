const VerifiedHTML=(username)=>{
    ...
    <body style="background-color: #f5f5f5; margin: 0; padding: 0; height: 100vh; display: flex; justify-content: center; align-items: center;">
        <div style="width: 100%; max-width: 450px; background-color: #ffffff; border-radius: 12px; box-shadow: 0px 4px 12px rgba(0, 0, 0, 0.1); padding: 30px; text-align: center; font-family: Arial, sans-serif;">
            ...
            <p style="color: #555; font-size: 16px; margin-bottom: 20px;">Thank you for registering with us, we are always at your service</p>
            ...
            <p style="color: #888; font-size: 14px; margin-top: 10px;">Connect with me on social media:</p>
